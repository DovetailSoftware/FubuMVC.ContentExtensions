...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.ContentExtensions"
COPYRIGHT = 'Copyright 2012 FubuMVC.ContentExtensions. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.ContentExtensions.sln', :clrversion => CLR_TOOLS_VERSION
